...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enableAd,  BannerAd? bannerAd)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdState() when $default != null:
return $default(_that.enableAd,_that.bannerAd);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enableAd,  BannerAd? bannerAd)  $default,) {final _that = this;
switch (_that) {
case _AdState():
return $default(_that.enableAd,_that.bannerAd);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enableAd,  BannerAd? bannerAd)?  $default,) {final _that = this;
switch (_that) {
case _AdState() when $default != null:
return $default(_that.enableAd,_that.bannerAd);case _:
  return null;
