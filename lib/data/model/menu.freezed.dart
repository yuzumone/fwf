...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  int value,  String link,  String text,  String image)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Menu() when $default != null:
return $default(_that.name,_that.value,_that.link,_that.text,_that.image);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  int value,  String link,  String text,  String image)  $default,) {final _that = this;
switch (_that) {
case _Menu():
return $default(_that.name,_that.value,_that.link,_that.text,_that.image);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  int value,  String link,  String text,  String image)?  $default,) {final _that = this;
switch (_that) {
case _Menu() when $default != null:
return $default(_that.name,_that.value,_that.link,_that.text,_that.image);case _:
  return null;
