...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String aria,  double lat,  double lng,  List<Menu> menus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Shop() when $default != null:
return $default(_that.name,_that.aria,_that.lat,_that.lng,_that.menus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String aria,  double lat,  double lng,  List<Menu> menus)  $default,) {final _that = this;
switch (_that) {
case _Shop():
return $default(_that.name,_that.aria,_that.lat,_that.lng,_that.menus);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String aria,  double lat,  double lng,  List<Menu> menus)?  $default,) {final _that = this;
switch (_that) {
case _Shop() when $default != null:
return $default(_that.name,_that.aria,_that.lat,_that.lng,_that.menus);case _:
  return null;
